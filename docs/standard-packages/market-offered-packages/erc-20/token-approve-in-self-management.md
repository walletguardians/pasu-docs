---
description: 다양한 dApp을 사용하는 사용자를 위한 자산 보호 정책 패키지
---
...
* 한 번에  설정된 한도보다 높은 금액을 approve하는 경우 경고합니다.
...
{% content-ref url="../../../standard-policies/market-offered-policies/token-erc-20/token-005.md" %}
[token-005.md](../../../standard-policies/market-offered-policies/token-erc-20/token-005.md)
{% endcontent-ref %}
