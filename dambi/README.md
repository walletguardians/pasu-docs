...
> **한 줄 요약** — "이 서명, 진짜 해도 되는 거 맞아?"를 서명 버튼을 누르기 **전에** 대신 확인해 줍니다.
...
| **마켓플레이스** | 미리 만들어진 정책을 찾아 설치하거나, 직접 만든 정책을 공유하는 정책 허브. |
| **대시보드** | 정책을 만들고·관리하고·시뮬레이션으로 테스트하는 관리 화면. |

## 누가 쓰나요?

* **지갑 사용자** — 확장프로그램을 설치하고 마켓에서 정책을 받아 보호받습니다. → [5분 튜토리얼](getting-started/tutorial.md)
* **정책 작성자/배포자** — 직접 정책을 만들어 마켓에 공유합니다.
...
[5분 튜토리얼](getting-started/tutorial.md)
{% endcontent-ref %}
